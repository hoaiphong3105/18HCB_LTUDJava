 ...
 * @author hoaip
 */
public class frmAddCourse extends javax.swing.JDialog {

    /**
     * Creates new form frmAddCourse
     */
    public frmAddCourse(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Thêm sinh viên vào khóa học");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        st.setStCode(txtStCode.getText());
        st.setStClass(cbClass.getSelectedItem().toString());
        st.setCourse(cbCourse.getSelectedItem().toString().split("-")[0].trim());

        boolean flag = StudentBUS.addStudent_Courses(st);
        if (flag) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmAddCourse dialog = new frmAddCourse(new javax.swing.JFrame(), true);
